...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=0.999, alpha=0.9):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = math.fabs(math.cos(self.alpha*self.counter))
            self.counter += 1
    ...
    def learn(self, state, action, reward):
        ...
        last_value = self.Q[state][action]
        if self.learning:
            self.Q[state][action] = (1-self.alpha)*last_value + self.alpha*(reward)
